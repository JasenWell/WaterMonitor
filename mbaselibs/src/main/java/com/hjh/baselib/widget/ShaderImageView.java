...
/**
 * Descroption:使用BitmapShader构造的圆形/圆角视图
...
public class ShaderImageView extends AppCompatImageView {
    ...
    public ShaderImageView(Context context, AttributeSet attrs) {
        ...
        mBorderRadius = a.getDimensionPixelSize(
                R.styleable.ShaderImageView_borderRadius, (int) TypedValue
                        .applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                                BODER_RADIUS_DEFAULT, getResources()
                                        .getDisplayMetrics()));// 默认为10dp
        type = a.getInt(R.styleable.ShaderImageView_type, TYPE_CIRCLE);// 默认为Circle
